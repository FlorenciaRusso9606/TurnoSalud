...
export default function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <span className="font-bold text-[#1d3557] text-base leading-none block">
                Hospital Cervantes
              </span>
      ...
      {/* Banner - foto del hospital de fondo con overlay */}
      <section
        className="relative flex items-center bg-cover bg-center pt-16"
        style={{
          minHeight: "380px",
          backgroundImage:
            "linear-gradient(rgba(29,53,87,1), rgba(29,53,87,0.80)), url('/hospital-cervantes.webp')",
        }}
      >
        <div className="max-w-6xl mx-auto px-8 py-16 text-white w-full">
          <p className="text-[11px] font-semibold tracking-widest uppercase text-[#a8dadc] mb-3">
          ...
          <p className="text-gray-200 text-base mb-8 max-w-md leading-relaxed">
            Solicitá turnos, consultá tus estudios y accedé a los servicios del
            hospital desde la plataforma.
          </p>
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <a
              href="#campanas"
              className="border border-white/40 hover:border-white text-white px-7 py-2.5 rounded-xl font-semibold text-sm transition-colors text-center"
            >
              Ver campañas
            </a>
          </div>
        ...
        {/* Franja emergencias - al pie del banner */}
        <div className="absolute bottom-0 left-0 right-0 bg-[#1d3557]/90 backdrop-blur-sm py-2.5 px-6">
          <div className="max-w-6xl mx-auto flex items-center justify-center gap-6 text-white/80 text-sm flex-wrap">
            ...
            <span>
              Guardia <strong className="text-white">(0298) 444-0000</strong>
            </span>
            <span className="text-white/30">·</span>
            <span>
              SAME <strong className="text-white">107</strong>
            </span>
            <span className="text-white/30">·</span>
            <span>
              Defensa Civil <strong className="text-white">103</strong>
            </span>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#f8fafc] py-16 px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-bold text-[#1d3557] mb-2 text-center">
            Servicios del hospital
          </h2>
          <p className="text-gray-500 text-center text-sm mb-10">
            Gestioná todo desde la plataforma, sin necesidad de acercarte al
            hospital
          </p>
            ...
            {services.map(({ icon: Icon, title, desc, href }) => (
              ...
              >
                <div className="w-12 h-12 bg-[#e6f5f3] rounded-xl flex items-center justify-center mb-4 group-hover:bg-[#2a9d8f] transition-colors">
                  <Icon
                    size={22}
                    className="text-[#2a9d8f] group-hover:text-white transition-colors"
                  />
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {campaigns.map(
              ({
                ...
                <div
                  key={title}
                  className={`${bg} rounded-2xl p-5 flex flex-col gap-3`}
                >
                  ...
                  <h3 className="font-semibold text-[#1d3557] text-sm leading-snug">
                    {title}
                  </h3>
      ...
      <section id="contacto" className="bg-[#f8fafc] py-16 px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-bold text-[#1d3557] mb-10 text-center">
            Dónde encontrarnos
          </h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="flex flex-col gap-6">
              <div className="bg-white rounded-2xl border border-gray-100 p-6">
                <h3 className="font-semibold text-[#1d3557] mb-4">
                ...
                <ul className="space-y-3 text-sm text-gray-600">
                  ...
                  <li className="flex items-center gap-3">
                    ...
                    <div>
                      <p>
                        Turnos: <strong>(0298) 444-0001</strong>
                      </p>
                      <p>
                        Guardia: <strong>(0298) 444-0000</strong>
                      </p>
                    </div>
                  </li>
                  <li className="flex items-center gap-3">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <p>
                        <strong>Consultorios externos:</strong> Lun – Vie, 7:00
                        – 19:00 hs
                      </p>
                      <p>
                        <strong>Guardia:</strong> Las 24 horas, los 365 días
                      </p>
                    </div>
                  </li>
                </ul>
              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <div
                      key={label}
                      className="bg-[#f8fafc] rounded-xl px-3 py-2.5 text-sm"
                    >
                      <span className="text-gray-500 block text-xs">
                        {label}
                      </span>
                      <strong className="text-[#1d3557] text-base">
                        {number}
                      </strong>
                    </div>
                  ))}
      ...
      <footer className="bg-[#1d3557] text-white py-8 px-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-white/50 text-center">
            © {new Date().getFullYear()} Hospital Cervantes · Ministerio de
            Salud · Provincia de Río Negro
          </p>
