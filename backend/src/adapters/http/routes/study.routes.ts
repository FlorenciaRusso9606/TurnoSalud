...
import { getMyStudies, getPatientStudies, uploadStudy, getStudyDownloadUrl } from '../controllers/study.controller'
...
router.get('/:studyId/download', authenticate, getStudyDownloadUrl)
